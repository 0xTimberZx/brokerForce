...
## UI Layout
- **Pair detail page:** large ORT score (0–100) with a qualitative label band (e.g. Poor / Fair / Good / Strong — exact bands TBD in Analytics.md), placed above the raw metrics so it reads as the headline, not a footnote. A small window switcher (30d / 90d / 200d) sits next to the score — 90d is the default on load.
