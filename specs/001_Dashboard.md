...
- `GET /watchlists/:userId/summary` — watched pairs with current scores, depends on `007 Watchlists` existing.
- `GET /users/:userId/recently-viewed` — recent pair view history.
